...
--------------------------------------------------------
Consultando todas las inscripciones con el detalle de cada alumno y el curso al cual está inscripto.
...
SELECT 
    ...
    Curso.cupos_maximos AS curso_cupos_maximos,
    Inscripcion.fecha_inscripcion
FROM 
    Inscripcion
JOIN 
    Alumno ON Inscripcion.alumno_id = Alumno.id
JOIN 
    Curso ON Inscripcion.curso_id = Curso.id;